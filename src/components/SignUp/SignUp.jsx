...
const SignUp = ({
	...
	}, [cleanErrorStack, hideHeader, showHeader])
	...
	if (isAuth) {
		...
		return (
			<div className={`text-center ${style.registrationPage}`}>
				<NavLink to={'/'}>
					<img
						className='mt-4 mb-3'
						src='5551.png'
				...
				<p className='mt-5 mb-3 text-muted'>
					@VPROFI.RU 2019 All rights reserved{' '}
				</p>

				{errorsFromInput && <ErrorAlert data={errorsFromInput} />}
			</div>
		)
	}
}
...
export default connect(mapStateToProps, { registration, cleanErrorStack })(
	SignUp
)
